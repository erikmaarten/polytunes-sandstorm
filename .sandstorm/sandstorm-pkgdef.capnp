...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "an05t5n6q40n0sedtd0t0rvvvkyzn6a9xrcwx3xqrjzvcpxwksj0",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Polytunes"),
    ...
    metadata = (
      ...
      website = "https://github.com/iwazaru/polytunes",
      # This should be the app's main website url.

      codeUrl = "https://github.com/iwazaru/polytunes",
      ...
      author = (
        ...
        upstreamAuthor = "Clément Bourgoin",
      ...
      shortDescription = (defaultText = "Two-player music game"),
